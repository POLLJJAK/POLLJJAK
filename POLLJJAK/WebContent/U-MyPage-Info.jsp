	...
	<main id="main">
		...
		<section class="inner-page">
			<div class="container" data-aos="fade-up">
				...
				<button class ="btn btn-primary" style="background-color: #3498db; border-radius: 50px; 
				margin-top: 20px; width: 50px; font-size: x-small; float: right; border: none; justify-content: flex-end;">수정</button>
				...
				<form class="form-horizontal">
					...
					<div class="form-inline form-group">
						<label for="pwCheck" class="col-sm-2 control-label">비밀번호
							확인 </label>
						<div class="col-sm-4 mb-3">
					...
					<div class="form-inline form-group">
						<label for="telephone" class="col-sm-2 control-label">전화번호
						</label>
						<div class="col-sm-4 mb-3">
					...
					<div class="form-inline form-group">
						<label for="persnal-part" class="col-sm-2 control-label">주요직무
						</label>
						<div class="col-sm-4 mb-3">
					...
					<div class="form-inline form-group">
						<label for="sub-persnal-part" class="col-sm-2 control-label">부가
							개인 역량 </label>
						<div class="col-sm-4 mb-3">
					...
					<div class="form-inline form-group">
						<label for="region" class="col-sm-2 control-label">모임 선호
							지역</label>
						<div class="col-sm-4 mb-3">
					...
					<div class="form-inline form-group">
						<label for="time" class="col-sm-2 control-label ">모임 선호 시간</label>
						<div class="radioBtn mb-3" id="time">
							<input type="radio" id="am" name="time" value="am"><label
								for="am">오전</label> <input type="radio" id="pm" name="time"
								value="pm"><label for="pm">오후</label>
						</div>
					</div>
					<div class="form-inline form-group">
						<label for="interests" class="col-sm-2 control-label">관심
							분야</label>
						<div class="col-sm-4 mb-3">
					...
					<div class="form-inline form-group">
						<label for="intro" class="col-sm-2 control-label">자기소개 </label>
						<div class="col-sm-4 mb-3">
							<textarea class="form-control" id="intro" rows="5">안녕하세요 착한사람입니다</textarea>
						</div>
					</div>
					<div class="form-inline form-group">
						<label for="pf" class="col-sm-2 control-label">포트폴리오 </label>
						<div class="col-sm-4 mb-3">
							<input type="text" class="form-control" id="pf" name="pf">
						</div>
					</div>
					<div class="form-inline form-group">
						<label for="persnal-skill" class="col-sm-2 control-label">주요기술
						</label>
						<div class="col-sm-4 mb-3">
				...
				<button class ="btn btn-primary" style="background-color: #3498db; border-radius: 50px; 
				margin-top: 20px; width: 100px;">수정완료</button>
			</div>
			<hr>
		</section>
	</main>
