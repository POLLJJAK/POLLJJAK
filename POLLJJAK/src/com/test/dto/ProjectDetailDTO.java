...
public class ProjectDetailDTO {
	...
	private String region_part;
	private String platform_part;
	private String skill_part;
	private String department_part;
	private String subject_part;
	...
	public String getRegion_part() {
		return region_part;
	}
	public void setRegion_part(String region_part) {
		this.region_part = region_part;
	}
	public String getPlatform_part() {
		return platform_part;
	}
	public void setPlatform_part(String platform_part) {
	...
	public String getDepartment_part() {
		return department_part;
	}
	public void setDepartment_part(String department_part) {
		this.department_part = department_part;
	}
	...
	public String getU_p_apply_date() {
		return u_p_apply_date;
	}
	public void setU_p_apply_date(String u_p_apply_date) {
		this.u_p_apply_date = u_p_apply_date;
	}
	public String getU_p_apply_reason() {
		return u_p_apply_reason;
	}
