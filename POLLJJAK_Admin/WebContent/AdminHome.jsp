...
<link rel="stylesheet" type="text/css" href="<%=cp%>/css/tabler-vendors.min.css">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item active">
								<a class="nav-link" href="./AdminHome.jsp">
									...
									<span class="nav-link-title"> 관리 홈 </span>
								</a>
							</li>
										...
										<div class="card-header">
											...
											<div class="ms-auto text-muted">
												<div class="ms-2 d-inline-block">
													<span class="dropdown">
														<button class="btn dropdown-toggle align-text-top" data-bs-boundary="viewport" data-bs-toggle="dropdown">문의사항</button>
								...
								<div class="row align-items-center">
									<div class="col-10">
										...
										<div class="markdown text-muted">
											...
											플랫폼 서비스입니다.<br />
											아래 바로가기 버튼을 누르면 서비스로 이동할 수 있습니다.
										<div class="mt-3">
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title">메인 배너 이미지 관리</h5>
						...
						<div class="modal-body">
							...
							<div class="mb-3">
		                       <div class="col-md-6 col-xl-12">
	                      		      ...
	                      		      <div class="mb-3">
			                            <div class="form-label">이미지 추가</div>
							...
							<label class="form-label">이미지 목록</label>
							
							<div class="row">
								<div class="col-10">
									<input type="text" class="form-control mb-2" name="example-text-input" placeholder="이미지1.png">								
								</div>
							...
							<div class="row">
								<div class="col-10">
									<input type="text" class="form-control mb-2" name="example-text-input" placeholder="이미지2.png">								
								</div>
							...
							<div class="row">
								<div class="col-10">
									<input type="text" class="form-control mb-2" name="example-text-input" placeholder="이미지3.png">								
								</div>
							...
							<div class="row">
								<div class="col-10">
									<input type="text" class="form-control mb-2" name="example-text-input" placeholder="이미지4.png">								
								</div>
