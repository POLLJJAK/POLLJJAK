...
public class FileManager
{
	...
	public static MultipartRequest upload(HttpServletRequest request, String saveFolderName) throws IOException
	{
		// 올린 파일들의 경로정보를 받아온다.(상대경로 /POLLJJAK 부터)
		String realFolder = "";
		...
		return new MultipartRequest(request, realFolder, maxSize, encType, new DefaultFileRenamePolicy());
	}
	
	// 업로드한 파일의 이름들을 가져온다
	public static ArrayList<String> getFileNames(MultipartRequest multi) throws UnsupportedEncodingException
	{
		...
		// 여기서 null이 찍힌다고라....
		//System.out.println("파일 매니저"+ multi.getOriginalFilename());
		...
		while (files.hasMoreElements())
		{
			...
			// 파일 매니저에서 건내주는 파일의 이름
			//System.out.println("파일매니저"+multi.getFilesystemName(file));
