      ...
      <header class="navbar navbar-expand-md navbar-light d-print-none">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="./static/pj_logo.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
          </h1>
            ...
            <div class="row row-deck row-cards">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">총 회원 수</div>
                    </div>
                    <div class="h1">2501</div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-2">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">모집 중인 프로젝트</div>
                    </div>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-0 me-2">321</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-2">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">진행 중인 프로젝트</div>
                    </div>
                    <div class="d-flex align-items-baseline">
              ...
              <div class="col-sm-6 col-lg-2">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">완료 프로젝트</div>
                    </div>
                    <div class="d-flex align-items-baseline">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="subheader">총 게시글 수</div>
                    </div>
                    <div class="d-flex align-items-baseline">
                      <div class="h1 mb-3 me-2">2,986</div>
                    </div>
