	...
	<div class="container" data-aos="fade-up">
		<div class="row">
			...
			<div class="col-lg-6 order-1 order-lg-2 hero-img"
				...
				<img src="assets/img/hero-img.png" class="img-fluid animated" alt="" style="height: auto;">
			</div>
		</div>
	</div>
</section>
...
<!-- 				<div class="carousel-caption d-none d-md-block">
		...
		<button class="carousel-control-prev" type="button"
			...
			style="background-color: black; background-size: 20px; border-radius: 16px;"></span> 
